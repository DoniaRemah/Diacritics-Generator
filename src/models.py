...
def load_data_for_extraction():
    ...
    globals.char_embeddings = utils.loadPickle('output/char_embeddings_35000_40000.pickle')
    ...
    globals.tokenized_sentences = utils.loadPickle('output/tokenized_sentences_35000_40000_withHamza.pickle')
...
def load_data_for_model_creation():
    ...
    globals.word_embeddings = utils.loadPickle('output/word_embeddings_35000_40000.pickle')
    print("finished loading word embeddings")
    globals.model_char_embeddings = utils.loadPickle('output/model/model_char_embeddings_35000_40000.pickle')
...
def load_saved_model(model_name,weight_name=""):
    ...
    name = "models/weights/folder_30000_35000/"+weight_name
...
def extract_char_embeddings_and_labels_align_labels():
    for sentece_index, sentence in enumerate(globals.golden_outputs_list[35000:40000]):
        chars_per_sentence_list = []
        chars_index_per_sentence_list = []
        labels_per_sentence_list = []
    ...
    utils.SaveToPickle('output/model/model_char_embeddings_35000_40000.pickle', globals.model_char_embeddings)
    utils.SaveToPickle('output/model/model_chars_index_per_corpus_35000_40000.pickle', globals.model_chars_index_per_corpus)
    utils.SaveToPickle('output/model/model_labels_35000_40000.pickle', globals.model_labels)
...
def chunk_data():
    ...
    utils.SaveToPickle('output/model/chunked_labels_35000_40000.pickle',globals.chunked_labels)
...
def pad_word_embeddings():
    ...
    utils.SaveToPickle('output/model/padded_word_embeddings_35000_40000.pickle',globals.padded_word_embeddings)
...
def pad_char_embeddings():
    ...
    utils.SaveToPickle('output/model/padded_char_embeddings_35000_40000.pickle',globals.padded_char_embeddings)

def prepare_data():
    load_data_for_model_creation()
    print("finished loading data for model creation")
    globals.model_labels=utils.loadPickle('output/model/model_labels_35000_40000.pickle')
    chunk_data()
...
def load_padded_data():
    globals.padded_word_embeddings=utils.loadPickle('output/model/padded_word_embeddings_35000_40000.pickle')
    globals.padded_char_embeddings=utils.loadPickle('output/model/padded_char_embeddings_35000_40000.pickle')
    globals.model_labels=utils.loadPickle('output/model/chunked_labels_35000_40000.pickle')
    ...
    # utils.SaveToPickle('output/model/word_embeddings_numpy_20000_25000.pickle', globals.word_embeddings_numpy)
    # utils.SaveToPickle('output/model/char_embeddings_numpy_20000_25000.pickle', globals.char_embeddings_numpy)
...
def training_model():
   ...
   # Define a callback to save the model weights after each epoch
    checkpoint_callback = ModelCheckpoint(
        filepath='models/weights/folder_35000_40000/weights_epoch_{epoch:02d}.h5',  # Specify the filename format
    ...
    for i in range(0, len(globals.word_embeddings_numpy), 2500):
        ...
        # name = "models/weights/folder_15000_20000/weights_epoch_01.h5"
        # globals.our_model.load_weights(name)
